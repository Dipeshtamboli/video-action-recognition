...
label_txt_file = 'new_split16_label.txt'

class Path(object):
    @staticmethod
    def db_dir(database,zsl):
        if database == 'ucf101':
            ...
            output_dir = "../data/UCF-101/split1" # if no preprocessing
            # if zsl =='no':
            #     output_dir = "../../data/UCF-101/split_UCF101" # if no preprocessing
...
class VideoDataset(Dataset):
    ...
    def __init__(self, dataset='ucf101', zsl='yes',split='train', clip_len=16, preprocess=False):
        self.root_dir, self.output_dir = Path.db_dir(dataset,zsl)
    ...
    def check_integrity(self):
        if not os.path.exists(self.root_dir):
            print("This_path_does_not_exists:",self.root_dir,self.output_dir)
            return False
        else:
            # print("path_exists",self.root_dir)
            return True
...
if __name__ == "__main__":
    ...
    train_data = VideoDataset(dataset='ucf101', split='complete_data', clip_len=16, preprocess=False)
